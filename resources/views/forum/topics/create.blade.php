            ...
            <div class="container mx-auto px-4">
                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div class="p-8">
                        ...
                        <form action="{{ route('forum-topics.store') }}" method="POST" class="space-y-6">
                            @csrf
                            ...
                            <div>
                                ...
                                <x-text-input id="title"
                                    ...
                                    :placeholder="__('forum.forms.title_placeholder')" required autofocus />
